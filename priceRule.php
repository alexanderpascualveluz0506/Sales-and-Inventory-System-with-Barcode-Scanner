 ...
 <link href="assets/css/lib/font-awesome.min.css" rel="stylesheet">
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
     <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
       <link href="codes/design/priceRule_style.css" rel="stylesheet">
</head>
                    ...
                    <li><a class="sidebar-sub-toggle" href="dashboard.php"><i class="fas fa-home" ></i> Dashboard </a>
                     ...
                     <li class="label">Item Management</li>
                        ...
                        <ul>
                            ...
                            <li><a href="priceRule.php">Price Rules</a></li>
                        </ul>
                    </li>
        ...
        <div class="main">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <span class="title-page"> <br>Dashboard / Item / Price Rules</span>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card" id="cardForStorage">
                ...
                <h3 class="display-5">Price Rules</h3>
       ...
       <label class="search-label">Search:</label>
            <div class="col-sm" >
                ...
                <div class="col-sm" style="margin-left: 50%">
                    <button type="button" class="btn btn-primary" onclick="window.location.href='AddPriceRules.php'">
                            <i class="ti-plus" style=""></i><span>&nbsp;PRICE RULE</span></button>
                </div>  
                        ...
                        <thead>
                            <tr>
                                <th class="table-header"><input type="checkbox" id="maincheckbox" name="vehicle1" value="Bike"></th>
                                 ...
                                 <th class="table-header">Rule Type</th>
