        ...
        <div class="col-lg-12">
            <div class="card" id="cardForStorage">
                  <div class="l-lcog-4 p-l-0 title-margin-left">
                    ...
                    <div class="container-title1"><h5>Supplier Report</h5></div>
                    ...
                    <div class="row g-3" id="row23" style="margin-left:4.5%; margin-top:2.7%; width: 70.4%;">
                           <label for="date" style="margin-right:30px;">Item Category</label>  
                           ...
                           <div class="col-sm" style="margin-left:-1%; height: 50px;">
                                 <select class="form-select" aria-label="Default select example" name="categories" id="selectItem">
                    ...
                    <div class="row g-3" id="row2" style="margin-left: 4%; width: 71%;margin-top: 1.5%;">
                            <label for="date" style="margin-right:30px;">Supplier Report</label>  
                           <div class="col-sm" style="margin-left:-1%">
                                <select class="form-select" aria-label="Default select example" name="categories">
                                        <option value="">All</option>
                                        <option value="Cash">With Sales Return</option>
                                        <option value="Cash">With Report Damaged Item</option>
                    ...
                    <div class="row g-3" id="row2" style="margin-left: 4%; width: 71%;margin-top: 2.7%;">
                            <label for="date" style="margin-right:30px;">Order Status&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>  
                           <div class="col-sm" style="margin-left:-1%">
                                <select class="form-select" aria-label="Default select example" name="categories" style="width:100%">
                                        <option value="">All</option>
                                        <option value="Cash">For Approval</option>
                                        <option value="Cash">Claimed</option>
                                        <option value="Cash">Waiting</option>
