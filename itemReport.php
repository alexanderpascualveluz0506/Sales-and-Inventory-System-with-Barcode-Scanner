                                        ...
                                        $result= $link->query($select);
                                            ...
                                            if ($result->num_rows >0){
                                                while ($row= $result->fetch_assoc()) {
                                                    ...
                                                    echo $value;
                                                    echo '<option value="'.$value.'">'.$row["category_name"].'</option>';
                                            }
                                        }
                                        ?> 
                                </select>  
                        ...
                        <div class="row g-3" id="row23" style="margin-left:4.5%; margin-top:2.7%; width: 70.4%;">
                           ...
                           <div class="col-sm" style="margin-left:-1%; height: 50px;">
                                <input list="item_list" style="height:36px; width: 100%;" id="selectItem">
                                  <datalist id="item_list" style="width:100%">
                                    <?php  
                                    include 'connection.php';
                                   ...
                                   $select= "SELECT * from inventory";
                                        ...
                                        $result= $link->query($select);
                                            ...
                                            if ($result->num_rows >0){
                                                while ($row= $result->fetch_assoc()) {
                                                    $value=$row["item_name"];
                                                    echo '<option value="'.$value.'">'.$row["barcode"].'</option>';
                                            }
                                        }
                                        ?> 
                                  </datalist>
  ...
  <center><div class="row" style="width:101%; " >
          <div style="text-align: center;width: 100%;margin-bottom: 1%;" id="print-div" >
               <center> <label style="font-size:20px;" id="title"></label><br>
                <span>To &nbsp;</span><label id="from"></label>
                  <span>&nbsp; From &nbsp;</span><label id="to"> </label>
            </center>
        </div>  
        <div class="col-lg-12" id="result-div" style="margin-top:-3%"> 
...
if($('#type').val() == "Top_Selling_Item_Report"){
...
if($('#type').val() == "Low_Selling_Item_Report"){
...
if($('#type').val() == "ExpiringItemReport"){
  
    $("#batch-no").prop("disabled", true); 
    $("#batch-yes").prop("checked", true);
...
if($('#type').val() == "LowInventorySummaryReport"){
...
$("#title").text(name+" of"+" "+categories+item+" "+"Items");
...
$("#to").text(dateTo);
 ...
 $.ajax({
  url: "codes/functions/itemReport_function.php",
  type: "POST",
