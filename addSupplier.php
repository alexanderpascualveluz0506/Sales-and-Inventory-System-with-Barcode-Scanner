 ...
 <link href="assets/css/lib/font-awesome.min.css" rel="stylesheet">
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
     <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.16.0/umd/popper.min.js"></script>
       <link href="codes/design/addSupplier_style.css" rel="stylesheet">
        ...
        <div class="nano">
            <div class="nano-content">
                <ul>
                    ...
                    <li><a href="supplier.php" style="background-color:#6880fc;color:white;"><i class="fas fa-users"></i>&nbsp;&nbsp;Supplier<span></a></li>
        ...
        <div class="main">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <span class="title-page"> <br>Dashboard / Supplier List / Add New Supplier</span>
                    </div>      
                </div>
...
<section id="main-content">
        ...
        <div class="col-lg-12">
            <div class="card" id="cardForStorage">
                  <div class="l-lcog-4 p-l-0 title-margin-left">
                       ...
                       <div class="container-title1"><h5><i class="fas fa-pen">&nbsp;&nbsp;</i>New Supplier
                      </h5>
    ...
    <div class="content-wrap" >
        <div class="main">
            <div class="container-fluid" style="width:97.4%; margin-left: 1%;">
...
<div id="drop-area">
    ...
    <label class="button" for="fileElem" style="background-color:#007bff; color:white;">Select some Images</label>
...
<div id='file-list-display'></div>
     ...
     <button type="submit" value="ADD ITEM" id="add_supplier" name="add_supplier_post" style="width:200px;height: 47px; margin-left: 78%; background-color:#054D7C; color:white; border-style: none; margin-top:2%; margin-bottom: 4%;">ADD SUPPLIER</button>
