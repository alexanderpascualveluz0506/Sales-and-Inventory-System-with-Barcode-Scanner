...
<div id="chartContainer" style="height: 300px; width: 100%;"></div>
  ...
  <canvas id="myChart" style="width:100%;" style="float: center;"></canvas>
...
var dateFrom1=$("#dateFromid").val();
var dateTo1=$("#dateToid").val();
...
success: function(data){       
    ...
    data: [{
            ...
            dataPoints: [
                { label: "Rent", y: rent },
                { label: "Tax", y: tax },
                { label: "Salary", y: salary },
                { label: "Water", y: water },
                { label: "Electricity", y: electricity }
