        ...
        <div class="main">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <span class="title-page"> <br>Dashboard / Inventory/ Storage Shelves</span>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card" id="cardForStorage">
                ...
                <h3 class="display-5">Storage Shelves</h3>
            

    <div class="row g-3" id="div-for-entries-show" style="width: 99%">
                    ...
                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th class="table-header">Shelves Name</th>  
                                <th class="table-header">Storage No</th>
                                <th class="table-header">Position</th>
                                <th class="table-header">Space Utilized</th>
                                 <th class="table-header">Batches</th>
                            ...
                            <tbody>
                                ...
                                $sql= mysqli_query($link,"SELECT * from shelves");
                                $i=1;
                                    if ($sql->num_rows>0){  
