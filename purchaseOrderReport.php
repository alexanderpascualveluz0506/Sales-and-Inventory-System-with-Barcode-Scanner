...
<?php
$type=$_GET['type'];
echo "<input type='text' id='type' value='$type'>";
        ...
        <div class="col-lg-12">
            <div class="card" id="cardForStorage">
                  <div class="l-lcog-4 p-l-0 title-margin-left">
                    ...
                    <div class="container-title1"><h5>Purchase Order Report</h5></div>
                    ...
                    <div>
                        ...
                        <div class="row g-3" id="row2">
                            ...
                            <label>Select Category</label>
                             <div class="col-sm" style="margin-left:2%">
                                <select class="form-select" aria-label="Default select example" name="categories" id="categoriesSelect">
                                    ...
                                    <div class="row g-3" id="row23" style="margin-left:4.5%; margin-top:2%; width: 70.4%;">
                           ...
                           <div class="col-sm" style="margin-left:-1%; height: 50px;">
                            ...
                            <div class="row g-3" id="row2" style="margin-top: 1%;">
                           <label for="date" style="margin-right:30px;">Payment Status:</label>  
                           <div class="col-sm" style="margin-left:-2%">
                                <select class="form-select" aria-label="Default select example" name="categories">
                                        <option value="Cash">Paid and Unpaid</option>
                           ...
                           <div class="row g-3" id="row2" style="">
                           <label for="date" style="margin-right:30px;">Payment Type:</label>  
                           <div class="col-sm" style="margin-left:-1%">
                                <select class="form-select" aria-label="Default select example" name="categories">
                                        <option value="">All</option>
                                        <option value="Cash">Cash</option>
                                        <option value="Cash">GCash</option>
                                        <option value="Cash">Other Online Payment</option>
