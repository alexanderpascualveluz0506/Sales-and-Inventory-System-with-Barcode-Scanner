            ...
            <div class="nano-content">
                <ul>
                   ...
                   <li><a href="dashboard.php" ><i class="fas fa-home" ></i> Dashboard </a>
                    ...
                    <li><a href="purchaseOrder.php" style="background-color:#6880fc;color:white;"><i class="fa fa-truck"></i>&nbsp;&nbsp;Purchase Orders</a></li>
        ...
        <div class="main">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <span class="title-page"> <br>&nbsp;Dashboard / Purchase Orders / Add Purchase Order</span>
                    </div>      
                </div>
        ...
        <div class="col-lg-12">
            <div class="card" id="cardForStorage">
                  <div class="l-lcog-4 p-l-0 title-margin-left">
                       ...
                       <div class="container-title1"><h5><i class="fas fa-pen">&nbsp;&nbsp;</i>New Purchase Order
                       </h5></div>
                           ...
                           <label>Purchase Order No</label>
                                 <div class="col-sm">
                                    <?php 
                                       ...
                                       $P=$count['total']+1;
                                       $PO='P10'.$P;
                                        echo '<input type="text" class="form-control" name="purchase_order_post" id="purchase-order-input" value='.$PO.'>';
                               ...
                               <div class="col-sm">
                                <div class="input-group">
                                   <select id="supplierselect" class="form-select" style="width:100%; height:40px; border-color:lightgray;" name="supplier_post">
                                        ...
                                        $select= "SELECT * from suppliers where company_name <> 'owner' ";
                        ...
                        <div class="row g-3" id="row4">
                           <label>Expected Delivery</label>
                                 <div class="col-sm">
                                        <input type="date" class="form-control" name="expected_delivery_post" id="item-name-input">
                                </div>
                        </div>
                        ...
                        <div class="row g-3" id="row5">
                            ...
                            <div class="col-sm">
                                <div class="input-group">
                                   <select id="" class="form-select" style="width:100%; height:40px; border-color:lightgray;" 
                      ...
                      <button type="button" class="btn btn-primary" id="add-new" style="width:20%; margin-left:2%">Add Item</button>
                    </div><br><br>
                    ...
                    <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                        <thead>
                            <tr>
                                 ...
                                 <th class="table-header" style="width:13%">Quantity</th>
                               
                                 <th class="table-header" style="width: 13%;">Discount %</th>
                ...
                <br>
                   ...
                   <div class="row g-3" id="row10" >
                        <labeL style="margin-left: -2%;">Discount For Entire Order </labeL>
                        <div class="col-sm">
                               <div class="input-group mb-3" style="width: 200px;">
                              <input type="text" class="form-control" aria-describedby="basic-addon2" 
                              id="overall-discount" name="overall_disc">
                              <div class="input-group-append" style="">
                                <span class="input-group-text" id="basic-addon2" style="background-color:#007575;color:white;">%</span>
                              </div>
                            </div>
                            <br>
                        <div class="col-sm" style="margin-left:-50%; ">
                            <button type="submit" name="Send-to-draft" id="send-to-draft" class="btn btn-primary">
                                <i class="fas fa-clipboard-list"  style="font-size:18px"></i>&nbsp;Save As Draft</button>
                        </div>
                        <div class="col-sm"style="margin-top:-16%; margin-left: 10%;">
                            <button type="submit" name="Send-to-email" id="send-to-email" class="btn btn-primary">
                                <i class="fas fa-envelope" style="font-size:18px"></i> &nbsp;Send To Email</button>
                        </div>
                    </div>
...
$("#add-new").click(function(){
 ...
 $("#body-of-table").append( '<tr><td><input type="text" value="'+value+'" class="form-control" name="item_name[]"></td><td><input type="text" class="form-control qty" name="qty[]"></td><td><input type="text" class="form-control" name="discount[]"></td></td><td style="background-color:white; border-style: none;"><div class="background" ><a id="remove-button"><i class="ti-close"></i></a></div></td></tr>' ); 
